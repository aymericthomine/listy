    ...
    <h1 class="mt-10; fixed-top; font-listy" style="color: #020202; font-size:20px; font-weight:bold; margin-top: 50px;">My Profile</h1>
            ...
            @include('navbar')
                ...
                <div class="flex" style="justify-content: space-evenly;">
                    ...
                    <a class="button-listy" style="color: white ; width: 120px" href="{{ route('profile') }}">
                        {{ __('Edit profile') }}
                    </a>
                    <a class="button2-listy" style="color: white; text-decoration: none; width: 120px" href="{{ route('profile') }}">
                        {{ __('Settings') }}
                    </a>
